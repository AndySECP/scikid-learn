...
TRAIN_DATA = [
    ...
    ("".join(["Students planted one hundred flower seeds They observed the growth of their plants once a week Which tool could be",
    	"used to record their observations"]), {"entities": [(17, 27, "CARDINAL"), (29, 34, "BIO"), (36, 40, "BIO"), (76, 81, "BIO"), 
    	(83, 86, "ORDINAL"), (90, 93, "DATE")]}),

    ("".join(["Study the data table below Two students want to know how temperature affects rubber bands They decide to test rubber",
    ...
    ("".join(["A balloon has a negative charge A glass rod has a positive charge What will happen when the glass rod is brought",
    ...
    ("".join(["The diagram below shows a landscape Where in the diagram would the air pressure be the greatest at the beach on top",
    ...
    ("".join(["The picture below shows several different birds What characteristic do all birds share They can fly They have feathers",
     "They have webbed feet They eat worms"]), 
     {"entities": [(4, 10, "VIZ"), (42, 46, "ANM"), (75, 79, "ANM"), (110, 117, "ANM"), (149, 153, "ANM")]}),

    ("".join(["Roger collected four rock samples and wrote a description of how each was formed Which of the following rocks that",
    ...
    ("".join(["Use the information below to answer the question Several students placed a toy truck on a table in front of a plane",
    ...
    ("".join(["Two circuits are shown below The light bulb of Circuit 1 does not glow The light bulb of Circuit 2 glows Which statement",
    ...
    ("".join(["A group of students investigated natural resources and the",
    ...
    ("".join(["The maps below show information about the air quality for one day in June",
